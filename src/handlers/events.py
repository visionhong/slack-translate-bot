...
def handle_direct_message(event: dict, say, client):
    ...
    async def process_dm():
        ...
        if not text:
            say("Please send me text to translate! 📝")
            return
        ...
        try:
            ...
            say("Sorry, translation failed. Please try again. 😔")
    
    asyncio.run(process_dm())
